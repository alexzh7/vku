...
<div uk-grid>
	...
	<div class="uk-width-2-3">
		...
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<table class="uk-table uk-table-divider shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
								...
								<td class="product-remove">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a href="%s" class="remove" uk-icon="minus-circle" aria-label="%s" data-product_id="%s" data-product_sku="%s"></a>',
