...
do_action( 'woocommerce_before_cart' ); ?>
	...
	<div class="steps-checkout" style="display:none;">
...
<div uk-grid>
	...
	<div class="uk-width-2-3@m">
		...
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<table class="uk-table uk-table-divider cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
				...
				<tbody>
								...
								<td class="product-remove">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a href="%s" class="remove" uk-icon="trash" aria-label="%s" data-product_id="%s" data-product_sku="%s"></a>',
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<button type="submit" class="uk-button uk-button-primary" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
